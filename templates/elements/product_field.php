...
if ( $type == 'price' ) {
	...
	} elseif ( ! $out_of_stock_only AND $product->managing_stock() ) {
	...
	return;
	// Discount Badge
} elseif ( $type == 'mry_discount' AND $product->is_on_sale() ) {
	...
	$_atts['class'] .= ' onsale discount-badge';
	$value .= $percentage;
